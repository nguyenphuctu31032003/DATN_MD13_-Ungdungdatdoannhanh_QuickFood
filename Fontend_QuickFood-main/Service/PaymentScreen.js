...
///
  const generateEncodedDateTime = () => {
    ...
    const formattedDateTime = `${currentDateTime.getFullYear()}-${(currentDateTime.getMonth()
        + 1).toString().padStart(2,
        '0')}-${currentDateTime.getDate().toString().padStart(2,
        '0')} ${currentDateTime.getHours().toString().padStart(2,
        '0')}:${currentDateTime.getMinutes().toString().padStart(2,
        '0')}:${currentDateTime.getSeconds().toString().padStart(2, '0')}`;
  ...
  return (
      <SafeAreaView style={styles.container}>
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity onPress={sendOrderToServer}
