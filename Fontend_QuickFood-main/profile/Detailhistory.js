...
const Detailhistory = ({route, navigation}) => {
  ...
  return (
      <View style={{flex: 1}}>
        <ToolBar title="Thông tin đơn hàng"
            ...
            <>
              <ScrollView>
                <View style={styles.orderDetails}>
                  ...
                  <Text style={styles.orderStatus}>Trạng thái: {getStatusLabel(
                      orderDetails.status)}</Text>
                  <Text style={styles.orderNumber}>Đơn hàng:
                    B-{orderDetails._id}</Text>
                </View>
                <View style={styles.addressContainer}>
                  <Text style={styles.restaurantAddress}>Nhà
                    hàng: {orderDetails.products[0].restaurantId.name}</Text>
                  <Image
                      source={require("./../Image//downarrow.png")}
                      style={styles.icon}
                  />

                  <Text style={styles.deliveryAddress}>Địa điểm
                    đến: {orderDetails.address}</Text>
                </View>
                ...
                <View style={styles.containerHD}>
                  <View style={styles.row}>
                    ...
                    <Text style={styles.value}>{calculateTotalPurchase(
                        orderDetails.products)}đ</Text>
                  </View>
                  <View style={styles.row}>
                  ...
                  <View style={styles.row}>
                    ...
                    <Text style={styles.value}>{!orderDetails.voucherId?.money
                        ? 0 : orderDetails.voucherId?.money}đ</Text>
      ...
      <Text> {orderDetails.voucherId?.money}</Text>
                  ...
                  <View style={styles.row}>
                    ...
                    <Text
                        style={styles.totalValue}>{orderDetails.toltalprice}đ</Text>
                  </View>
                  <View style={styles.row}>
                    <Text style={styles.totaltt}>Phương thức thanh toán</Text>
                    <Text
                        style={styles.totaltt}>{orderDetails.phuongthucthanhtoan}</Text>
                  </View>
                </View>
                ...
                <View style={styles.helpContainer}>
                              ...
                              <Stars
                                  ...
                                  fullStar={<Icon name={'star'} size={50}
                                                  style={[styles.myStarStyle,
                                                    {color: 'yellow'}]}/>}
                                  emptyStar={<Icon name={'star-o'} size={50}
                                                   style={[styles.myStarStyle,
                                                     {color: 'blue'}]}/>}
                              />
                              <TouchableOpacity
                  ...
                  <TouchableOpacity style={styles.reorderButton}
                                    onPress={goHome}>
                    <Text style={styles.reorderButtonText}>Quay về trang
                      chủ</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>
